...
const Footer: FC<FooterProps> = ({ slice }) => {
  return (
    <footer className="relative w-full mt-32">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between">
            ...
            <div className="text-sm text-gray-400 font-mono tracking-wider">
              ...
              <span className="glitch-text relative inline-block">
                ...
                <span className="glitch-text-r absolute top-0 left-0 w-full">
                  {slice.primary.field}
                </span>
                <span className="glitch-text-b absolute top-0 left-0 w-full">
                  {slice.primary.field}
                </span>
              </span>
              <span className="text-primary">{` }`}</span>
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1/2 h-px bg-primary/10 blur-sm" />
